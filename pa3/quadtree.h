...
public:
    ...
    void renderhelper(PNG& imIn, Node* n) const;
    ...
    void prunehelper(Node* n, int tol);
    ...
    int shelper(Node* n, const int tol) const;
    ...
    int ihelper(const int leaves, int min, int max) const;
...
private:
    ...
    quadtree::Node* copyhelper(Node* curr);
